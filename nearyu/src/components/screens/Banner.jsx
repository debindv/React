...
const Banner = () => {
    return (
        <Top>
            ...
            <Arrow>
                <LinkBanner to="/"><Round><Image src={require("../../assets/images/arrow.png")} alt="arrow"/></Round></LinkBanner>
                <LinkBanner to="/"><Round><RightArrow src={require("../../assets/images/arrow.png")} alt="arrow"/></Round></LinkBanner>
            </Arrow>
        </Top>
    )
}
